...
CATALOG: list[CatalogSeries] = [
    CatalogSeries(
        ...
        category="tv-shows",
        description=(
            "Anthology series exploring paranormal events, "
            "hosted by John Newland (1959-1961)."
        ),
        seasons=[
            CatalogSeason(
                number=1,
                episodes=[
                    ...
                    CatalogEpisode(
                        "The Dead Part of the House", "OneStepBeyond-TheDeadPartOfTheHouse", 1, 9
                    ),
            ...
            CatalogSeason(
                ...
                episodes=[
                    CatalogEpisode(
                        ...
                        "sherlockholmes-cunninghamheritage",
                        1,
                        1,
                    ),
                    CatalogEpisode(
                        "The Case of Lady Beryl", "SherlockHolmes-TheCaseOfLadyBeryl", 1, 2
                    ),
                    CatalogEpisode(
                        "The Case of the Pennsylvania Gun",
                        "SherlockHolmes-TheCaseOfThePennsylvaniaGun",
                        1,
                        3,
                    ),
                    CatalogEpisode(
                        "The Case of the Texas Cowgirl",
                        "SherlockHolmes-TheCaseOfTheTexasCowgirl",
                        1,
                        4,
                    ),
                    CatalogEpisode(
                        "The Case of the Belligerent Ghost",
                        "SherlockHolmes-TheCaseOfTheBelligerentGhost",
                        1,
                        5,
                    ),
                    CatalogEpisode(
                    ...
                    CatalogEpisode(
                        ...
                        "SherlockHolmes-TheCaseOfTheWinthropLegend",
                        1,
                        7,
                    ),
                    CatalogEpisode(
                        "The Case of the Blind Man's Bluff",
                        "SherlockHolmes-TheCaseOfTheBlindMansBluff",
                        1,
                        8,
                    ),
                    CatalogEpisode(
                        "The Case of Harry Crocker", "SherlockHolmes-TheCaseOfHarryCrocker", 1, 9
                    ),
                    CatalogEpisode(
                        "The Case of the Shoeless Engineer",
                        "SherlockHolmes-TheCaseOfTheShoelessEngineer",
                        1,
                        10,
                    ),
                ],
    ...
    CatalogSeries(
        ...
        category="tv-shows",
        description=(
            "Classic western series starring Clayton Moore "
            "as the masked lawman (1949-1957)."
        ),
        seasons=[
            CatalogSeason(
                number=1,
                episodes=[
                    CatalogEpisode(
                        "Enter the Lone Ranger", "TheLoneRanger-EnterTheLoneRanger", 1, 1
                    ),
                    CatalogEpisode("The Lone Ranger Fights On", "lone_ranger_fights_on", 1, 2),
                    CatalogEpisode(
                        "The Lone Ranger's Triumph", "TheLoneRanger-TheLoneRangersTriumph", 1, 3
                    ),
    ...
    CatalogSeries(
        ...
        seasons=[
            CatalogSeason(
                ...
                episodes=[
                    CatalogEpisode(
                        "The Clampetts Strike Oil", "BeverlyHillbillies-TheClampettsStrikeOil", 1, 1
                    ),
                    CatalogEpisode("Getting Settled", "BeverlyHillbillies-GettingSettled", 1, 2),
                    CatalogEpisode(
                        "Meanwhile, Back at the Cabin",
                        "BeverlyHillbillies-MeanwhileBackAtTheCabin",
                        1,
                        3,
                    ),
                    CatalogEpisode(
                        "The Clampetts Meet Mrs. Drysdale",
                        "BeverlyHillbillies-TheClampettsMeetMrsDrysdale",
                        1,
                        4,
                    ),
                    ...
                    CatalogEpisode(
                        "Jethro Goes to School", "BeverlyHillbillies-JethroGoesToSchool", 1, 8
                    ),
                    CatalogEpisode("Elly's First Date", "BeverlyHillbillies-EllysFirstDate", 1, 9),
                    CatalogEpisode(
                        "Pygmalion and Elly", "BeverlyHillbillies-PygmalionAndElly", 1, 10
                    ),
                ],
            ),
        ],
            ...
            CatalogSeason(
                ...
                episodes=[
                    CatalogEpisode(
                        ...
                        "DickVanDykeShow-TheSickBoyAndTheSitter",
                        1,
                        1,
                    ),
                    ...
                    CatalogEpisode(
                        ...
                        "DickVanDykeShow-SallyAndTheLabTechnician",
                        1,
                        4,
                    ),
                    CatalogEpisode(
                        "Oh How We Met the Night That We Danced",
                        "DickVanDykeShow-OhHowWeMetTheNightThatWeDanced",
                        1,
                        5,
                    ),
                    CatalogEpisode(
                        "Harrison B. Harding of Camp Crowder, Mo.",
                        "DickVanDykeShow-HarrisonBHarding",
                        1,
                        6,
                    ),
                    CatalogEpisode(
                        "My Blonde-Haired Brunette", "DickVanDykeShow-MyBlondeHairedBrunette", 1, 7
                    ),
                    CatalogEpisode(
                        "To Tell or Not to Tell", "DickVanDykeShow-ToTellOrNotToTell", 1, 8
                    ),
                ],
            ),
        ],
    ...
    CatalogSeries(
        ...
        category="tv-shows",
        description=(
            "Rod Serling's anthology horror/sci-fi series "
            "set in an eerie art gallery (1969-1973)."
        ),
        seasons=[
            CatalogSeason(
                number=1,
                episodes=[
                    CatalogEpisode(
                        "The Cemetery / Eyes / Escape Route", "NightGallery-Pilot", 1, 1
                    ),
                    CatalogEpisode("The Dead Man", "NightGallery-TheDeadMan", 1, 2),
                    CatalogEpisode(
                        "Room With a View / The Little Black Bag",
                        "NightGallery-RoomWithAView",
                        1,
                        3,
                    ),
                    CatalogEpisode(
                        "The House / Certain Shadows on the Wall", "NightGallery-TheHouse", 1, 4
                    ),
                    CatalogEpisode("Make Me Laugh", "NightGallery-MakeMeLaugh", 1, 5),
                    CatalogEpisode(
                        "Clean Kills and Other Trophies", "NightGallery-CleanKills", 1, 6
                    ),
                ],
            ),
        ],
    ...
    CatalogSeries(
        ...
        category="tv-shows",
        description=(
            "The crew of the submarine Seaview face "
            "underwater adventures and threats (1964-1968)."
        ),
        seasons=[
            CatalogSeason(
                number=1,
                episodes=[
                    CatalogEpisode(
                        "Eleven Days to Zero", "VoyageToTheBottomOfTheSea-ElevenDaysToZero", 1, 1
                    ),
                    CatalogEpisode(
                        "The City Beneath the Sea",
                        "VoyageToTheBottomOfTheSea-CityBeneathTheSea",
                        1,
                        2,
                    ),
                    CatalogEpisode(
                        "The Fear Makers", "VoyageToTheBottomOfTheSea-TheFearMakers", 1, 3
                    ),
                    CatalogEpisode(
                        "The Mist of Silence", "VoyageToTheBottomOfTheSea-MistOfSilence", 1, 4
                    ),
                    CatalogEpisode(
                        "The Price of Doom", "VoyageToTheBottomOfTheSea-ThePriceOfDoom", 1, 5
                    ),
                    CatalogEpisode(
                        "The Sky Is Falling", "VoyageToTheBottomOfTheSea-TheSkyIsFalling", 1, 6
                    ),
                    CatalogEpisode(
                        "Turn Back the Clock", "VoyageToTheBottomOfTheSea-TurnBackTheClock", 1, 7
                    ),
                    CatalogEpisode(
                        "The Village of Guilt", "VoyageToTheBottomOfTheSea-VillageOfGuilt", 1, 8
                    ),
                ],
            ),
        ],
        ...
        seasons=[
            CatalogSeason(
                ...
                episodes=[
                    ...
                    CatalogEpisode(
                        "Night of the Living Dead (1968)", "night_of_the_living_dead", 1, 2
                    ),
                    CatalogEpisode(
                        "House on Haunted Hill (1959)", "house_on_haunted_hill_1959", 1, 3
                    ),
                    ...
                    CatalogEpisode(
                        "The Little Shop of Horrors (1960)", "the_little_shop_of_horrors", 1, 7
                    ),
                    CatalogEpisode(
                        "Plan 9 from Outer Space (1957)", "Plan_9_from_Outer_Space_1959", 1, 8
                    ),
                ],
            ),
        ],
        ...
        seasons=[
            CatalogSeason(
                ...
                episodes=[
                    ...
                    CatalogEpisode(
                        "Teenagers from Outer Space (1959)", "teenagers_from_outer_space", 1, 2
                    ),
                    ...
                    CatalogEpisode(
                        "Attack of the Giant Leeches (1959)", "attack_of_the_giant_leeches", 1, 5
                    ),
                    CatalogEpisode(
                        "The Brain That Wouldn't Die (1962)", "the_brain_that_wouldnt_die", 1, 6
                    ),
                ],
            ),
        ],
